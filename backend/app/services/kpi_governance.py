...
KPI_REGISTRY: dict[str, dict[str, str]] = {
    ...
    "break_even_target": {
        "definition": "Minimum monthly sales required to cover all fixed expenses.",
        "formula": "monthly_fixed_expenses / contribution_margin",
        "source": "Business Settings (fixed_expenses, contribution_margin_pct)",
        "refresh": "On settings change / daily",
        "owner": "Owner",
    },
    "operating_target": {
        "definition": "Monthly sales required to cover fixed expenses plus the desired profit.",
        "formula": "(monthly_fixed_expenses + desired_profit) / contribution_margin",
        "source": "Business Settings (fixed_expenses, desired_monthly_profit, contribution_margin_pct)",
        "refresh": "On settings change / daily",
        "owner": "Owner",
    },
    "stretch_target": {
        "definition": "Operating target lifted by the configured growth objective.",
        "formula": "operating_target * (1 + growth_pct/100)",
        "source": "Business Settings (growth_pct)",
        "refresh": "On settings change / daily",
        "owner": "Owner",
    },
    "projected_month_end": {
        "definition": "Straight-line projection of month-end sales at the current daily pace.",
        "formula": "mtd_sales + (mtd_sales/days_elapsed) * remaining_days",
        "source": "daily_channel_sales (trusted) + calendar",
        "refresh": "Daily, on file upload",
        "owner": "Restaurant Manager",
    },
    "data_trust": {
